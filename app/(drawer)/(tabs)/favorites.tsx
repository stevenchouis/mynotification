  ...
  if (favoriteIds.length === 0) {
    return (
      <View style={styles.emptyContainer}>
        <Ionicons name="heart-outline" size={48} color="#D8D2C4" />
...
const styles = StyleSheet.create({
  ...
  thumb: { width: CARD_WIDTH, height: CARD_WIDTH, borderRadius: 10, backgroundColor: '#F5F3EF', marginBottom: 8 },
  favoriteButton: {
  ...
  title: { fontSize: 13, color: '#333333', fontWeight: '500', lineHeight: 18 },
  price: { fontSize: 12, color: '#8A8377', marginTop: 4, fontWeight: '600' },
  emptyContainer: { flex: 1, backgroundColor: '#fff', justifyContent: 'center', alignItems: 'center', padding: 40 },
  emptyText: { fontSize: 15, color: '#8A8377', marginTop: 12, fontWeight: '600' },
  emptySubtext: { fontSize: 12, color: '#B0AA9C', marginTop: 6, textAlign: 'center' },
});
